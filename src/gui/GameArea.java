...
public class GameArea extends JPanel implements MummyMazeListener {
    ...
    private void loadImages() {
        trap = Toolkit.getDefaultToolkit().getImage(getClass().getResource("/gui/sprites/armadilha.png"));
        key = Toolkit.getDefaultToolkit().getImage(getClass().getResource("/gui/sprites/chave.png"));
        stairsDown = Toolkit.getDefaultToolkit().getImage(getClass().getResource("/gui/sprites/escadaBaixo.png"));
        stairsUp = Toolkit.getDefaultToolkit().getImage(getClass().getResource("/gui/sprites/escadaCima.png"));
        stairsRight = Toolkit.getDefaultToolkit().getImage(getClass().getResource("/gui/sprites/escadaDireita.png"));
        stairsLeft = Toolkit.getDefaultToolkit().getImage(getClass().getResource("/gui/sprites/escadaEsquerda.png"));
        scorpion = Toolkit.getDefaultToolkit().getImage(getClass().getResource("/gui/sprites/escorpiao.png"));
        hero = Toolkit.getDefaultToolkit().getImage(getClass().getResource("/gui/sprites/explorador.png"));
        beackground = Toolkit.getDefaultToolkit().getImage(getClass().getResource("/gui/sprites/fundo.png"));
        mummyWhite = Toolkit.getDefaultToolkit().getImage(getClass().getResource("/gui/sprites/mumiaBranca.png"));
        mummyRed = Toolkit.getDefaultToolkit().getImage(getClass().getResource("/gui/sprites/mumiaVermelha.png"));
        wallHorizontal = Toolkit.getDefaultToolkit().getImage(getClass().getResource("/gui/sprites/paredeHorizontal.png"));
        wallVertical = Toolkit.getDefaultToolkit().getImage(getClass().getResource("/gui/sprites/paredeVertical.png"));
        doorHorizontalOpen = Toolkit.getDefaultToolkit().getImage(getClass().getResource("/gui/sprites/portaHorizontalAberta.png"));
        doorHorizontalClosed = Toolkit.getDefaultToolkit().getImage(getClass().getResource("/gui/sprites/portaHorizontalFechada.png"));
        doorVerticalOpen = Toolkit.getDefaultToolkit().getImage(getClass().getResource("/gui/sprites/portaVerticalAberta.png"));
        doorVerticalClosed = Toolkit.getDefaultToolkit().getImage(getClass().getResource("/gui/sprites/portaVerticalFechada.png"));
    }
